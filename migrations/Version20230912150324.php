 ...
 */
final class Version20230912150324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649F232F209 FOREIGN KEY (schoolsite_id) REFERENCES campus (id)');
